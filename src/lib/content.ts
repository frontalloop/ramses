...
const ar = {
  meta: {
    title: "رامسيس سيرفيس | حلول متكاملة للنظافة والتشغيل",
    description:
      "رامسيس سيرفيس شركة متخصصة في خدمات النظافة المتكاملة وإدارة عمليات النظافة للمؤسسات الحكومية والخاصة في مصر، بخبرة تتجاوز 10 سنوات.",
  },
  dir: "rtl",
  langLabel: "EN",
  ...
  about: {
    ...
    body: [
      "رامسيس سيرفيس شركة متخصصة في تقديم خدمات النظافة المتكاملة وإدارة عمليات النظافة للمؤسسات الحكومية والخاصة في مصر.",
    ...
    imageAlt: "فريق رامسيس سيرفيس أثناء العمل في أحد المواقع",
  },
