...
const ar = {
  ...
  clients: {
    ...
    works: [
      { name: "ميناء دمياط (الحاويات)", type: "gov" },
      { name: "شركة مياه الشرب والصرف الصحي بدمياط", type: "gov" },
      { name: "شركة مارشال للاستيراد والتصدير (ميناء دمياط)", type: "industry" },
      { name: "شركة فان بورد الأمريكية", type: "industry" },
      { name: "قرية رأس البر زمان 1", type: "commercial" },
      { name: "قرية رأس البر زمان (صن ست 2)", type: "commercial" },
      { name: "مول الصياد بلازا", type: "commercial" },
      { name: "مول الصفوة", type: "commercial" },
      { name: "مول حسن البداح", type: "commercial" },
      { name: "مستشفى كفر شكر التخصصي", type: "health" },
      { name: "مستشفى بلطيم العام", type: "health" },
      { name: "مستشفى الأزهر بدمياط الجديدة", type: "health" },
      { name: "مستشفى الشروق", type: "health" },
      { name: "مستشفى الصفا بدمياط", type: "health" },
      { name: "شركة دانون كفر الشيخ", type: "industry" },
      { name: "شركة دانون دمياط", type: "industry" },
      { name: "شركة دانون الدقهلية", type: "industry" },
      { name: "محكمة العاشر من رمضان", type: "gov" },
      { name: "محكمة مشتول السوق", type: "gov" },
      { name: "محكمة أبو حماد بالشرقية", type: "gov" },
      { name: "محكمة الزقازيق الابتدائية", type: "gov" },
      { name: "محكمة الزراعة بالشرقية", type: "gov" },
      { name: "محكمة المرور بالشرقية", type: "gov" },
      { name: "مأمورية بلبيس بالشرقية", type: "gov" },
      { name: "محكمة بلبيس الجزئية", type: "gov" },
      { name: "مأمورية منيا القمح بالشرقية", type: "gov" },
      { name: "محكمة منيا القمح الجزئية", type: "gov" },
      { name: "محكمة دمياط الابتدائية بدمياط", type: "gov" },
      { name: "محكمة كفر سعد", type: "gov" },
      { name: "محكمة الزقازيق الكلية", type: "gov" },
      { name: "فندق كورتيل", type: "commercial" },
      { name: "مركز النور للعيون", type: "health" },
      { name: "محلات سيد أبو شريف", type: "commercial" },
      { name: "مطاعم البير", type: "commercial" },
      { name: "مجموعة شركات المنصورة جروب (توكيل برسيل)", type: "industry" },
      { name: "مصنع المهندس للأثاث", type: "industry" },
      { name: "أسواق الأسرة السعيدة", type: "commercial" },
      { name: "مجزر دمياط للدواجن (كوكو شامة)", type: "industry" },
      { name: "معرض الحناوي", type: "commercial" },
      { name: "كافيه كارلتون", type: "commercial" },
      { name: "مجموعة معارض السما للسيارات", type: "commercial" },
      { name: "نادي فينيسيا الاجتماعي", type: "commercial" },
      { name: "بنزينة طاقة - دمياط الجديدة", type: "commercial" },
...
const en: typeof ar = {
  ...
  clients: {
    ...
    works: [
      { name: "Damietta Port (Containers)", type: "gov" },
      { name: "Damietta Drinking Water & Sanitation Company", type: "gov" },
      { name: "Marshall Import & Export Company (Damietta Port)", type: "industry" },
      { name: "Van Board American Company", type: "industry" },
      { name: "Ras El Bar Zaman Village 1", type: "commercial" },
      { name: "Ras El Bar Zaman Village (Sun Set 2)", type: "commercial" },
      { name: "El Sayad Plaza Mall", type: "commercial" },
      { name: "Al Safwa Mall", type: "commercial" },
      { name: "Hassan El Baddah Mall", type: "commercial" },
      { name: "Kafr Shokr Specialized Hospital", type: "health" },
      { name: "Baltim General Hospital", type: "health" },
      { name: "Al-Azhar Hospital – New Damietta", type: "health" },
      { name: "Al Shorouk Hospital", type: "health" },
      { name: "Al Safa Hospital – Damietta", type: "health" },
      { name: "Danone Kafr El Sheikh", type: "industry" },
      { name: "Danone Damietta", type: "industry" },
      { name: "Danone Dakahlia", type: "industry" },
      { name: "10th of Ramadan Court", type: "gov" },
      { name: "Mashtoul El Souq Court", type: "gov" },
      { name: "Abu Hammad Court – Sharqia", type: "gov" },
      { name: "Zagazig Primary Court", type: "gov" },
      { name: "Agriculture Court – Sharqia", type: "gov" },
      { name: "Traffic Court – Sharqia", type: "gov" },
      { name: "Belbeis Mission Office – Sharqia", type: "gov" },
      { name: "Belbeis District Court", type: "gov" },
      { name: "Minya El Qamh Mission Office – Sharqia", type: "gov" },
      { name: "Minya El Qamh District Court", type: "gov" },
      { name: "Damietta Primary Court", type: "gov" },
      { name: "Kafr Saad Court", type: "gov" },
      { name: "Zagazig General Court", type: "gov" },
      { name: "Cortel Hotel", type: "commercial" },
      { name: "Al Noor Eye Center", type: "health" },
      { name: "Sayed Abu Sherif Stores", type: "commercial" },
      { name: "Al Beer Restaurants", type: "commercial" },
      { name: "Mansoura Group Companies (Persil Agency)", type: "industry" },
      { name: "Al Mohandes Furniture Factory", type: "industry" },
      { name: "Al Osra Al Saeeda Markets", type: "commercial" },
      { name: "Damietta Poultry Slaughterhouse (Coco Shama)", type: "industry" },
      { name: "El Hannawy Showroom", type: "commercial" },
      { name: "Carlton Cafe", type: "commercial" },
      { name: "Al Sama Car Showrooms Group", type: "commercial" },
      { name: "Venezia Social Club", type: "commercial" },
      { name: "Taqa Gas Station – New Damietta", type: "commercial" },
